...
class Vocabulary():
    ...
    def build_from_snli(self, use_subset = False, unk_src="average"):
        """Builds the vocabulary from words in the entire SNLI corpus for which GloVe embeddings exist.

        Args:
            use_subset (bool, optional): _description_. Defaults to False.
            unk_src (str, optional): _description_. Defaults to "average".
        """
        ...
        if unk_src == "average":
            ...
            raise NotImplementedError(f"Unknown strategy for obtaining unknown token: {unk_src}")
