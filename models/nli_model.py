...
class NLIModel(pl.LightningModule):
    def __init__(self, encoder_name = None, encoder = None, classifier = None, encoder_hparams = {}):
        ...
        assert (encoder is None and classifier is None) ^ (encoder_name is None), "Either pre-trained encoder and classifier or an encoder_name must be specified to build SLIModel."
